...
public partial class PaySuccess : System.Web.UI.Page
{
    ...
    public void createOrder(string cartID, string TrId, string Reference)
    {
        ...
        if (tbl.Rows.Count > 0)
        {
            ...
            cmd.Parameters.AddWithValue("@current_state", "9");
            cmd.Parameters.AddWithValue("@secure_key", TrId);

            cmd.Parameters.AddWithValue("@payment", "RazorPay");
            cmd.Parameters.AddWithValue("@conversion_rate", "1.000000");
            cmd.Parameters.AddWithValue("@module", "RazorPay");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                gData.InsOrderHistory(UserID, maxOrderID, "9");
                ...
                cmd.Parameters.AddWithValue("@payment_method", "RazorPay");
