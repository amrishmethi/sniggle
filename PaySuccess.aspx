<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PaySuccess.aspx.cs" Inherits="PaySuccess" %>
                    ...
                    <tr>
                        <td style="width: 100%; padding-right: 10px; padding-left: 10px; height: 200px;">
                            <div id="DivDetailSuccess" runat="server" class="normaltxt1" style="color: green;">
                                <strong>Your Payment at <a href="https://sniggle.in/" style="font-weight: bold">sniggle.in</a>  for Order No 
    <asp:Label ID="lblOrderno" runat="server"></asp:Label>
                                    has been successfully paid.<br />
                                    <br />
                            </div>
                            <div id="DivDetailFailed" runat="server" class="normaltxt1" visible="false" style="color: indianred;">
                                <strong>Your Payment at <a href="https://sniggle.in/" style="font-weight: bold">sniggle.in</a>  for this Order  
