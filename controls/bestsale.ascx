<%@ Control Language="C#" ClassName="bestsale" %>
...
<!------------------1 new arrivals block close--------->
<!------------------3 last view product block ---------->
<div id="divLastViewProd" runat="server" class="hidden-sm-down">
    <div id="search_filters">
...
<!------------------3 last view product block close ---------->
