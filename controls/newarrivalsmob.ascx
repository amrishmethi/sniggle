<%@ Control Language="C#" ClassName="newarrivalsmob" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            rptBestSellingMob.DataSource = dt;
            rptBestSellingMob.DataBind();
...
<!------------------ Best selling on mobile--------->
<div class="hidden-xl-up">
    <div id="search_filters" class="links p-0">
        <div class="title clearfix" data-target="#bestselling" data-toggle="collapse">
            ...
            <p class="h6">Best Selling</p>
        </div>
        <section class="facet clearfix collapse" id="bestselling">
                        ...
                        <div class="listcateproduct-products">
                            <div class="row pos_content pl-1 pr-1">
                                <div class="listcateSlide owl-carousel">
                                    <asp:Repeater ID="rptBestSellingMob" runat="server">
                                        <ItemTemplate>
