<%@ Control Language="C#" ClassName="sideProducts" %>
...
<!------------------1 new arrivals block mobile--------->
<div id="search_filters_wrapper" class="hidden-sm-down hidden-md-down">
    <div id="search_filters">
        <p class="text-uppercase h6 hidden-sm-down">New Arrivals</p>
        <section class="facet clearfix">
            <div id="facet_001" class="poslistcateproduct poslistcateproduct_0 product_container collapse"
                data-items="1"
                data-speed="1000"
                data-autoplay="0"
                data-time="0"
...
<!------------------1 new arrivals block mobile close---------> 
<!------------------2 Best selling block mobile--------->
<div id="search_filters_wrapper" class="hidden-sm-down  hidden-md-down">
    <div id="search_filters">
...
<!------------------2 Best selling block mobile close 2----->

<!------------------3 last view product block mobile ---------->
