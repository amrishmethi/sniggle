...
public class AdminGetData
{
    ...
    public void LogError(string ErrorName, string ErrorLocation, string Form, string ErrorDetails)
    {
        cmd = new SqlCommand("Usp_ErrorLogIns");
    ...
    public DataSet GetCMS(string PageSize, string pageIndex, string Name, string meta_title, string link_rewrite, string position)
    {
        ...
        if (link_rewrite != "")
            ...
            cmd.Parameters.AddWithValue("@link_rewrite", '%');
        if (position != "")
            cmd.Parameters.AddWithValue("@position", position);
        else cmd.Parameters.AddWithValue("@position", '%');
    ...
    public DataSet GetProductList(string PageSize, string pageIndex, string ID, string name, string reference, string name_category, string price, string sav_quantity, string active, string IsHome,string StockForBarCode)
    {
        ...
        if (StockForBarCode != "")
            cmd.Parameters.AddWithValue("@StockForBarCode", StockForBarCode);
        else
            cmd.Parameters.AddWithValue("@StockForBarCode", '%');
        if (active != "")
            cmd.Parameters.AddWithValue("@active", active);
        else
            cmd.Parameters.AddWithValue("@active", '%');
    ...
    public int AddProductFeature(string id_feature, string id_product, string id_feature_value, string value)
    {
        ...
        if (value != "")
        {
            ...
            else
            {
                ...
                {
                    data.executeCommand("delete from ps_feature_product where id_product='" + id_product + "' and id_feature='" + id_feature + "'");
    ...
    public int AddattributeG(string value, string public_name, string ID, string Action,string group_type)
    {
        status = 0;
        ...
        cmd1.Parameters.AddWithValue("@ID", ID);
        cmd1.Parameters.AddWithValue("@Action", Action);
        cmd1.Parameters.AddWithValue("@group_type", group_type);
        var result = data.executeCommand(cmd1);
        status = Convert.ToInt32(result.ToString());

        return status;
    }
    public int AddattributeV(string id_attribute_group, string value, string ID, string Action,string Metatitle, string Metadescription, string Metakeywords, string Url, string Image,string description,string color)
    {
        status = 0;
        ...
        cmd1.Parameters.AddWithValue("@ID", ID);
        cmd1.Parameters.AddWithValue("@Action", Action);
        cmd1.Parameters.AddWithValue("@meta_title", Metatitle);
        cmd1.Parameters.AddWithValue("@meta_description", Metadescription);
        cmd1.Parameters.AddWithValue("@meta_keywords", Metakeywords);
        cmd1.Parameters.AddWithValue("@link_rewrite", Url);
        cmd1.Parameters.AddWithValue("@CoverImage", Image);
        cmd1.Parameters.AddWithValue("@description", description);
    ...
    public int InsBanner(string Action, string Title, string Type, string Banner, string DisplayIndex, string id, string Link, string LinkOpen, string BannerFor)
    {
        ...
        cmd.Parameters.AddWithValue("@BannerFor", BannerFor);
        status = data.executeCommand(cmd);
    ...
    public DataSet GetCustomer(string PageSize, string pageIndex, string id_customer, string firstname, string email,
        string active, string newsletter, string optin, string FDate, string TDate)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetCustomerNew");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        cmd.Parameters.AddWithValue("@PageSize", PageSize);
        cmd.Parameters.AddWithValue("@PageIndex", pageIndex);
        ...
        if (firstname != "")
            cmd.Parameters.AddWithValue("@CName", firstname);
        else
    ...
    public DataSet AddBlogPost(string Action, string id_smart_blog_post, string meta_title, string meta_keyword, string meta_description,
        string short_description, string content, string link_rewrite,string PostedBy)
    {
    ...
    public DataSet AddCartRules(string Action, string id_customer, string date_from, string date_to, string description, string quantity,
        ...
        string reduction_percent, string reduction_amount, string reduction_currency, string active, string id_cart_rule, string name,string minimum_amount_shipping)
    {
        ...
        cmd.Parameters.AddWithValue("@name", name);
        cmd.Parameters.AddWithValue("@minimum_amount_shipping", minimum_amount_shipping);
        ds = data.getDataSet(cmd);
        return ds;
    }
    public DataSet GetReviewAdmin(string PageSize, string pageIndex, string customer_name, string title, string content, string name, string date_from, string date_to, string Status)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        ...
        if (name != "")
            ...
            cmd.Parameters.AddWithValue("@name", '%');
        if (date_from != "")
            cmd.Parameters.AddWithValue("@FDate", ConvertToDateTime(date_from));
        else
            cmd.Parameters.AddWithValue("@FDate", "1900-01-01");
        if (date_to != "")
            cmd.Parameters.AddWithValue("@TDate", ConvertToDateTime(date_to));
        else
            cmd.Parameters.AddWithValue("@TDate", dd2);
    ...
    public DataSet GetRAQdmin(string PageSize, string pageIndex, string FullName, string Email, string FDate, string TDate)
    {
        ...
        if (TDate != "")
            ...
            cmd.Parameters.AddWithValue("@TDate", DateTime.Now.ToString("yyyy-M-d"));
        cmd.Parameters.AddWithValue("@PageSize", PageSize);
        cmd.Parameters.AddWithValue("@PageIndex", pageIndex);
        cmd.Parameters.Add("@RecordCount", SqlDbType.Int, 4);
        cmd.Parameters["@RecordCount"].Direction = ParameterDirection.Output;
    ...
    public DataSet GetCustomdmin(string PageSize, string pageIndex, string FullName, string Email, string FDate, string TDate)
    {
    ...
    public DataSet GetContactUs(string PageSize, string pageIndex, string FullName, string Email, string FDate, string TDate)
    {
    ...
    public DataSet GetProductEnquiry(string PageSize, string pageIndex, string FullName, string Email, string ProdName, string FDate, string TDate)
    {
    ...
    public DataSet GetReOrderEnquiry(string PageSize, string pageIndex, string FullName, string Email, string ProdName, string FDate, string TDate)
    {

        cmd = new SqlCommand("Sp_GetReOrderEnquiry");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (ProdName != "")
            cmd.Parameters.AddWithValue("@ProdName", ProdName);
    ...
    public DataSet GetCreativeCutsEnquiry(string PageSize, string pageIndex, string FullName, string Email, string ProdName, string FDate, string TDate)
    {
    ...
    public DataSet GetProductTag(string PageSize, string pageIndex, string id_product, string name, string tag)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetProductTagList");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (id_product != "")
            cmd.Parameters.AddWithValue("@id_product", id_product);
        else
            cmd.Parameters.AddWithValue("@id_product", '%');
        if (name != "")
            cmd.Parameters.AddWithValue("@name", name);
        else
            cmd.Parameters.AddWithValue("@name", '%');
    ...
    public DataSet GetZone(string PageSize, string pageIndex, string name, string Ship_Amt, string MinShip_Amt)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetZoneAdmin");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (name != "")
            cmd.Parameters.AddWithValue("@name", name);
            ...
            cmd.Parameters.AddWithValue("@name", '%');
        if (Ship_Amt != "")
            cmd.Parameters.AddWithValue("@Ship_Amt", Ship_Amt);
        else
            cmd.Parameters.AddWithValue("@Ship_Amt", '%');
        if (MinShip_Amt != "")
            cmd.Parameters.AddWithValue("@MinShip_Amt", MinShip_Amt);
        else
            cmd.Parameters.AddWithValue("@MinShip_Amt", '%');
        cmd.Parameters.AddWithValue("@PageSize", PageSize);
        cmd.Parameters.AddWithValue("@PageIndex", pageIndex);
        cmd.Parameters.Add("@RecordCount", SqlDbType.Int, 4);
        cmd.Parameters["@RecordCount"].Direction = ParameterDirection.Output;
    ...
    public DataSet GetCountry(string PageSize, string pageIndex, string id_country, string name, string iso_code, string call_prefix, string zoneName)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetCountryAdmin");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (name != "")
            cmd.Parameters.AddWithValue("@name", name);
        ...
        if (id_country != "")
            ...
            cmd.Parameters.AddWithValue("@id_country", '%');
        if (iso_code != "")
            cmd.Parameters.AddWithValue("@iso_code", iso_code);
        else
            cmd.Parameters.AddWithValue("@iso_code", '%');
        if (call_prefix != "")
            cmd.Parameters.AddWithValue("@call_prefix", call_prefix);
        else
            cmd.Parameters.AddWithValue("@call_prefix", '%');
        if (zoneName != "")
    ...
    public DataSet GetCarrier(string PageSize, string pageIndex, string name)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetcarrierAdmin");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (name != "")
            cmd.Parameters.AddWithValue("@name", name);
    ...
    public DataSet GetZipCode(string PageSize, string pageIndex, string name, string ZipCode, string Amount)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetZipCoderAdmin");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (name != "")
            cmd.Parameters.AddWithValue("@name", name);
    ...
    public DataSet GetCustomerPaymentStatus(string PageSize, string pageIndex, string id_cart, string id_order, string Name, string Status)
    {
        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetCustomerPaymentStatus");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (id_cart != "")
            cmd.Parameters.AddWithValue("@id_cart", id_cart);
    ...
    public DataSet GetCarrtRule(string name, string code, string quantity, string active, string PageSize, string pageIndex)
    {

        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetCartRuleAdmin");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        if (name != "")
            cmd.Parameters.AddWithValue("@name", name);
    ...
    public DataSet GetLastViewProduct(string PageSize, string pageIndex)
    {

        string dd2 = DateTime.Now.ToString("yyyy-M-d");
        cmd = new SqlCommand("Sp_GetLastViewProductAdmin");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        //if (name != "")
        //    cmd.Parameters.AddWithValue("@name", name);
    ...
    public int InsFilter(string CatId, string AttrId,string Position)
    {
        status = 0;
        cmd1 = new SqlCommand("[Usp_InsFilterData]");
        cmd1.CommandType = CommandType.StoredProcedure;
        cmd1.Parameters.Clear();
        cmd1.Parameters.AddWithValue("@CatId", CatId);
        cmd1.Parameters.AddWithValue("@AttrId", AttrId);
        cmd1.Parameters.AddWithValue("@Position", Position);
        status = data.executeCommand(cmd1);

        return status;
    }
    public int SizeChartIns(string Action,string ID, string CategoryId,string Image,string Description)
    {
        status = 0;
        cmd = new SqlCommand("SizeChartIns");
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Clear();
        cmd.Parameters.AddWithValue("@Action", Action);
        cmd.Parameters.AddWithValue("@ID", ID);
    ...
    public void CategoryDrp(DropDownList drop)
    {
        ds = data.getDataSet("Select * from ps_category_lang where isdeleted=0 ");
        drop.DataSource = ds;
