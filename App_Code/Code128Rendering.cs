...
namespace barcodegenerator
{
    ...
    public static class Code128Rendering
    {
        ...
        public static byte[] MakeBarcodeImage(string InputData, int BarWeight, bool AddQuietZone)
        {
            ...
            //System.Web.UI.WebControls.Image myimg = new System.Drawing.Bitmap(width, height);
            ...
            using (Bitmap bitmap = new Bitmap(width, height))
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    //imgbar.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(byteimage);
                }
            }
