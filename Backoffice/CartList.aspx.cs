...
public partial class Backoffice_CartList : System.Web.UI.Page
{
    Data data = new Data();
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetShopingCart(PageSize.ToString(), pageIndex.ToString(), txtID.Text, txtOrderId.Text, txtCustomer.Text,txtCarrir.Text,txtFDate.Text,txtTdate.Text,txtTotal.Text);
    ...
    protected void drpPageSize_TextChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("CartList.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
    }
