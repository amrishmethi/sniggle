<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AttributeValue.aspx.cs" Inherits="Backoffice_AttributeValue" %>
                    ...
                    <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="row">
                                    <h1 style="float: left">Product Attribute value</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">PRODUCT ATTRIBUTES VALUE</span> LIST</h1>
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <ul id="sortable">
                                <li>
                                    <table id="table" class="table">
                                        <tr>
                                            ...
                                            <th data-field="Values" style="text-align: left; width: 30%;">Values</th>
                                ...
                                <asp:ListView ID="ItemsListView" runat="server" ItemPlaceholderID="myItemPlaceHolder" OnItemCommand="ItemsListView_ItemCommand" OnItemDeleting="ItemsListView_ItemDeleting">
                                    <ItemTemplate>
                                        <li id='id_<%# Eval("id_attribute") %>' style="min-height: 35px">
                                            <table id="ListViewTable" class="table">
                                                <tr class="gradeA">
                                                    <td style="text-align: left; width: 5%;">
                                                        <input runat="server" name="chk" id="chk" type="checkbox" class="checkitem" /></td>
                                                    <td style="text-align: left; width: 5%;"><%#Eval("id_attribute") %>
                                                        <asp:Label ID="lblId" runat="server" Text='<%#Eval("id_attribute") %>' Visible="false"></asp:Label>
                                                    </td>
                                                    <td style="text-align: left; width: 30%;">
                                                        <%#Eval("name") %> 
                                                    </td>
                                                    ...
                                                    <td style="text-align: right; width: 20%;">
                                                        <div class="row">
                                                            <a href='AddAttributeValue.aspx?id=<%#Eval("id_attribute") %>' class="btn btn-custon-rounded-three btn-primary" style="width: 25px; padding: 4px 3px;"><i class="fa fa-pencil-square-o fa-align-center" style="color: white;"></i></a>
                                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                                CommandArgument='<%#Eval("id_attribute") %>' Style="width: 25px; padding: 4px 3px;"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function OnSortableUpdate(event, ui) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'Sortable.asmx/UpdateAttValueOrder',
