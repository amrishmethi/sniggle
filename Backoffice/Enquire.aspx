<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Enquire.aspx.cs" Inherits="Backoffice_Enquire" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        <li><a href="Enquire.aspx">Modules</a> <span class="bread-slash">/</span>
                                        </li>
                                        <li><span>Enquire about this product</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Enquire about this product</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='ViewEnquire.aspx?id=<%#Eval("ID") %>' class=" btn btn-info " rel="lightbox" style="color: white; width: 25px; padding: 4px 3px;"><i class="fa fa-eye fa-align-center" style="color: white;"></i></a>
