...
public partial class Backoffice_CreativeCutsEnquiry : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                data.executeCommand("update tbl_CreativeCutsEnquiry set Notification=0  ");
                Response.Redirect("CreativeCutsEnquiry.aspx");
            }
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Data data = new Data();
            string query = "update tbl_ProductEnquiry set IsDeleted = 1 where ID=" + e.CommandArgument + "";
            ...
            Response.Redirect("CreativeCutsEnquiry.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
    }
    ...
    {
        txtEmail.Text = txtName.Text = txtProduct.Text = "";
        if (Request.QueryString["PageNo"] != null)
            pageNo = Convert.ToInt32(Request.QueryString["PageNo"]);
        else
            pageNo = 1;
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetCreativeCutsEnquiry(drpPageSize.SelectedValue, pageIndex.ToString(), txtName.Text, txtEmail.Text,txtProduct.Text,txtFDate.Text,txtTdate.Text);
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("CreativeCutsEnquiry.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnEnable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_CreativeCutsEnquiry set Active = 1 where ID=" + lblid.Text + "");
            }
        }
    ...
    protected void btnDisable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_CreativeCutsEnquiry set Active = 0 where ID=" + lblid.Text + "");
            }
        }
