...
public partial class Backoffice_Testimonials : System.Web.UI.Page
{
    Data data = new Data();
    ...
    public void FillData(int pageIndex)
    {
        ...
        ds = gdate.GetTestimonial(drpPageSize.SelectedValue, pageIndex.ToString(), txtAuthor.Text, txtAuthorinfo.Text, txtURL.Text,txtEmail.Text,txtcontent.Text);
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Data data = new Data();
            string query = "update ps_prestahome_testimonial set IsDeleted = 1 where id_prestahome_testimonial=" + e.CommandArgument + "";
            ...
            Response.Redirect("Testimonials.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
        if (e.CommandName == "Des")
        {

            data.executeCommand("update ps_prestahome_testimonial set active = (case when active=1 then 0 else 1 end) where id_prestahome_testimonial=" + e.CommandArgument + "");
            if (Request.QueryString["PageNo"] != null)
                pageNo = Convert.ToInt32(Request.QueryString["PageNo"]);
            else
                pageNo = 1;
    ...
    {
        txtAuthor.Text =txtAuthorinfo.Text=txtcontent.Text=txtEmail.Text=txtURL.Text= "";
        if (Request.QueryString["PageNo"] != null)
            pageNo = Convert.ToInt32(Request.QueryString["PageNo"]);
        else
            pageNo = 1;
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("Testimonials.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            {
                Data data = new Data();
                data.executeCommand("update ps_prestahome_testimonial set IsDeleted = 1 where  id_prestahome_testimonial=" + lblid.Text);
            }
        }
    ...
    protected void btnEnable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update ps_prestahome_testimonial set Active = 1 where  id_prestahome_testimonial=" + lblid.Text + "");
            }
        }
    ...
    protected void btnDisable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update ps_prestahome_testimonial set Active = 0 where  id_prestahome_testimonial=" + lblid.Text + "");
            }
        }
