...
public partial class Backoffice_ReOrder : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                data.executeCommand("update tbl_ProductEnquiry set Notification=0  where Subject='From Reorder' ");
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetReOrderEnquiry(drpPageSize.SelectedValue, pageIndex.ToString(), txtName.Text, txtEmail.Text, txtProduct.Text, txtFDate.Text, txtTdate.Text);
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            if (Request.QueryString["PageNo"] != null)
                ...
                pageNo = 1;
            Response.Redirect("ReOrder.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
    }
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("ReOrder.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            {
                Data data = new Data();
                data.executeCommand("update tbl_ProductEnquiry set IsDeleted = 1 where ID=" + lblid.Text);
            }
        }
    ...
    protected void btnEnable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_ProductEnquiry set Active = 1 where ID=" + lblid.Text + "");
            }
        }
    ...
    protected void btnDisable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_ProductEnquiry set Active = 0 where ID=" + lblid.Text + "");
            }
        }
