<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AttributesGroups.aspx.cs" Inherits="Backoffice_AttributesGroups" %>
                                ...
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        <li>Catalog<span class="bread-slash">/</span>
                                          ...
                                          <li><a  href="AttributesGroups.aspx"> Product Attributes</a>
                                        </li>
                                       
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Product Attributes</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignright" style="margin-top: -21px;">
                                        ...
                                        <li style="margin-right: 10px"><a href="AddAttributeValue.aspx">
                                            <h3 style="text-align: center"><i class="fa fa-plus-square" aria-hidden="true"></i></h3>
                                            <h5 style="float: left">Add New Attribute Value</h5>
                                        </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">PRODUCT ATTRIBUTES</span> LIST</h1>
                    ...
                    <div class="sparkline13-graph" >
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <ul id="sortable">
                                <li>
                                    <table id="table" class="table">
                                        <tr>
                                            ...
                                            <th data-field="Values count" style="text-align: left; width: 15%;">Values count</th>
                                            <th data-field="Position " style="text-align: left; width: 15%;">Position</th>
                                ...
                                <asp:ListView ID="ItemsListView" runat="server" ItemPlaceholderID="myItemPlaceHolder" OnItemCommand="ItemsListView_ItemCommand" OnItemDeleting="ItemsListView_ItemDeleting1">
                                    <ItemTemplate>
                                        <li id='id_<%# Eval("id_attribute_group") %>'  style="height: 35px;">
                                            <table id="ListViewTable" class="table">
                                                <tr>
                                                    <td style="text-align: left; width: 5%;">   
                                                        <input runat="server" name="chk" id="chk" type="checkbox"  class="checkitem" /></td>
                                                    <td style="text-align: left; width: 5%;">
                                                        <asp:Label ID="lblId" runat="server" Text='<%#Eval("id_attribute_group") %>' ></asp:Label>
                                                         </td>
                                                    <td style="text-align: left; width: 30%;">
                                                        <%#Eval("name") %> 
                                                    </td>
                                                    ...
                                                    <td style="text-align: center; width: 15%;">
                                                        <div class="row">
                                                            <a href='AddAttribute.aspx?id=<%#Eval("id_attribute_group") %>' style="display: normal; padding: 4px 12px;" class="btn-info "><i class="fa fa-pencil-square-o" style="color: white;"></i></a>
                                                            <a href='AttributeValue.aspx?gid=<%#Eval("id_attribute_group") %>' style="display: normal; padding: 4px 12px;" class="  btn-info " rel="lightbox" style="color: white;"><i class="fa fa-eye" style="color: white;"></i></a>
                                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Style="display: normal; padding: 4px 12px;" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                                CommandArgument='<%#Eval("id_attribute_group") %>'><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <%--</ContentTemplate>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function OnSortableUpdate(event, ui) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'Sortable.asmx/UpdateAttributesOrder',
