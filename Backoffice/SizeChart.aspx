<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SizeChart.aspx.cs" Inherits="Backoffice_SizeChart"  %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        ...
                                        <li><a href="SizeChart.aspx">Size Chart</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Size Chart</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignright" style="margin-top: -21px;">
                                        <li><a href="SizeChartAdd.aspx">
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Size Chart</span> List</h1>
                                    ...
                                    <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand">
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                    <img src='../img/SizeChart/<%#Eval("Image") %>' height="100px" width="100px" />
                                                </td>
                                                <td>
                                                    <%#Eval("name") %>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='SizeChartAdd.aspx?id=<%#Eval("ID") %>' class="btn btn-custon-rounded-three btn-primary" style="width: 25px; padding: 4px 3px;"><i class="fa fa-pencil-square-o fa-align-center" style="color: white;"></i></a>
