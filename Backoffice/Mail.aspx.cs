...
public partial class Backoffice_Mail : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            Response.Redirect("Mail.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
    }
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetMail(drpPageSize.SelectedValue, pageIndex.ToString(), "", "","","");
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("Mail.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            {
                Data data = new Data();
                data.executeCommand("delete from ps_mail where id_mail=" + lblid.Text);
            }
        }
    ...
    protected void btnEnable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_Mail set Active = 1 where ID=" + lblid.Text + "");
            }
        }
    ...
    protected void btnDisable_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_Mail set Active = 0 where ID=" + lblid.Text + "");
            }
        }
