<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="BlogPost.aspx.cs" Inherits="Backoffice_BlogPost" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="row">
                                    ...
                                    <h3 style="float: left">Blog Post</h3>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignright" style="margin-top: -21px;">
                                        <li><a href="AddBlogPost.aspx">
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">BLOG POST </span>
                                ...
                                <tbody>
                                    ...
                                    <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand1">
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                    <asp:Label ID="lblId" runat="server" Visible="false" Text='<%#Eval("id_smart_blog_post") %>'></asp:Label>
                                                    <input runat="server" name="chk" id="chk" type="checkbox" class="checkitem" /></td>
                                                <td><%#Eval("id_smart_blog_post") %> </td>
                                                <td>
                                                    <%#Eval("viewed") %> 
                                                </td>
                                                <td>
                                                    <img src='<%#Eval("img") %>' height="100px" width="100px" />
                                                </td>
                                                <td>
                                                    <%#Eval("meta_title") %>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lnkDetail" runat="server" CommandName="Ac" CommandArgument='<%#Eval("id_smart_blog_post") %>'>
                                        <%# bool.Parse(Eval("active").ToString())==true ? "<img src='../img/show.gif' title='Make Show' border='0'/>":"<img src='../img/hide.gif' title='Make Hide' border='0'/>" %>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <a href='AddBlogPost.aspx?id=<%#Eval("id_smart_blog_post") %>' class="btn btn-custon-rounded-three btn-primary" style="width: 25px; padding: 4px 3px;"><i class="fa fa-pencil-square-o fa-align-center" style="color: white;"></i></a>
                                                        ...
                                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                            CommandArgument='<%#Eval("id_smart_blog_post") %>' Style="width: 25px; padding: 4px 3px;"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    </div>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
