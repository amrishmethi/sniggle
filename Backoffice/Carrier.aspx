<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Carrier.aspx.cs" Inherits="Backoffice_Carrier" %>
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Carrier</span> List</h1>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblid" runat="server" Text='<%#Eval("id_carrier") %>' Visible="false"></asp:Label>
                                                </td>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='AddCarrier.aspx?id=<%#Eval("id_carrier") %>' class="btn btn-custon-rounded-three btn-primary" style="width: 25px; padding: 4px 3px;"><i class="fa fa-pencil-square-o fa-align-center" style="color: white;"></i></a>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                            CommandArgument='<%#Eval("id_carrier") %>' Style="width: 25px; padding: 4px 3px;"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    </div>
