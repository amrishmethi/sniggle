<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ContactUs.aspx.cs" Inherits="Backoffice_ContactUs" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        <li><a href="ContactUs.aspx">Modules</a> <span class="bread-slash">/</span>
                                        </li>
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Contact Us</span> List</h1>
                                            ...
                                            <tr class="gradeA">
                                               <td>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='ViewContactUs.aspx?id=<%#Eval("ID") %>' class=" btn btn-info " rel="lightbox" style="color: white; width: 25px; padding: 4px 3px;"><i class="fa fa-eye fa-align-center" style="color: white;"></i></a>
