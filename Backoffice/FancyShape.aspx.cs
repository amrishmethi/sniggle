...
public partial class Backoffice_FancyShape : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void ItemsListView_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        {
            Data data = new Data();
            string query = "update tbl_FancyShape set IsDeleted = 1 where ID=" + e.CommandArgument + "";
        ...
        if (e.CommandName == "A")
        {
            ...
            data.executeCommand("update tbl_FancyShape set Active = (case when Active=1 then 0 else 1 end) where ID=" + e.CommandArgument + "");
        ...
        if (Request.QueryString["PageNo"] != null)
            ...
            pageNo = 1;
        Response.Redirect("FancyShape.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
    }
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetFancyShape(drpPageSize.SelectedValue, pageIndex.ToString(), txtCat.Text, txtTitle.Text);
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("FancyShape.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem checkedItem in ItemsListView.Items)
        {
            ...
            {
                Data data = new Data();
                string query = "update tbl_FancyShape set IsDeleted = 1  where ID=" + lblid.Text + "";
                data.executeCommand(query);
                string query1 = "update tbl_FancyShape_lang set IsDeleted = 1  where ID=" + lblid.Text + "";
    ...
    protected void btnEnable_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem checkedItem in ItemsListView.Items)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_FancyShape set active = 1 where ID=" + lblid.Text + "");
    ...
    protected void btnDisable_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem checkedItem in ItemsListView.Items)
        {
            ...
            if (chk.Checked == true)
            {
                data.executeCommand("update tbl_FancyShape set active = 0 where ID=" + lblid.Text + "");
