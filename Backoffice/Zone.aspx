<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Zone.aspx.cs" Inherits="Backoffice_Zone" %>
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Zone</span> List</h1>
                            ...
                            <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="Zone Name">Zone Name</th>
                                        <th data-field="Shipping Amount">Shipping Amount </th>
                                        <th data-field="Free Shipping Minimum Amount">Free Shipping Minimum Amount </th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtShipAmt" CssClass="form-control" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtMinShipAmt" CssClass="form-control" runat="server"></asp:TextBox></td>
                                        <td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblid" runat="server" Text='<%#Eval("id_zone") %>' Visible="false"></asp:Label>
                                                </td>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='AddZone.aspx?id=<%#Eval("id_zone") %>' class="btn btn-custon-rounded-three btn-primary" style="width: 25px; padding: 4px 3px;"><i class="fa fa-pencil-square-o fa-align-center" style="color: white;"></i></a>
                                                        ...
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                            CommandArgument='<%#Eval("id_zone") %>' Style="width: 25px; padding: 4px 3px;"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    </div>
