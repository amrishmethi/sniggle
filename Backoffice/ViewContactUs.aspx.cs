...
public partial class Backoffice_ViewContactUs : System.Web.UI.Page
{
    Data data = new Data();
    ...
    {
        ds = data.getDataSet("select * from tbl_ContactUs where IsDeleted=0 and ID='" + Request.QueryString["id"].ToString() + "'");
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            //lblCName.Text = ds.Tables[0].Rows[0][""].ToString();
        }
    }
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            Data data = new Data();
            string query = "update tbl_ContactUs set IsDeleted = 1 where ID=" + Request.QueryString["id"].ToString() + "";
