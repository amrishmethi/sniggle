<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Testimonials.aspx.cs" Inherits="Backoffice_Testimonials" %>
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n text-capitalize">Testimonials</span> List</h1>
                            ...
                            <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="Author info">Author info</th>
                                        <th data-field="URL">URL</th>
                                        <th data-field="E-mail">E-mail</th>
                                        <th data-field="Testimonial content">Testimonial content</th>
                                        <th>Displayed</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAuthorinfo" CssClass="form-control" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtcontent" CssClass="form-control" runat="server"></asp:TextBox></td>
                                    ...
                                    <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand">
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblid" runat="server" Text='<%#Eval("id_prestahome_testimonial") %>' Visible="false"></asp:Label>
                                                </td>
                                                <td><%#Eval("id_prestahome_testimonial") %></td>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lnkDetail" runat="server" CommandName="Des" CommandArgument='<%#Eval("id_prestahome_testimonial") %>'>
                                        <%# bool.Parse(Eval("active").ToString())==true ? "<img src='../img/show.gif' title='Make Hide' border='0'/>":"<img src='../img/hide.gif' title='Make Show' border='0'/>" %>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='AddTestimonials.aspx?id=<%#Eval("id_prestahome_testimonial") %>' class=" btn btn-info " rel="lightbox" style="color: white; width: 25px; padding: 4px 3px;"><i class="fa fa-pencil fa-align-center" style="color: white;"></i></a>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                            CommandArgument='<%#Eval("id_prestahome_testimonial") %>' Style="width: 25px; padding: 4px 3px;"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    </div>
