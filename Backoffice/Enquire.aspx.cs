...
public partial class Backoffice_Enquire : System.Web.UI.Page
{
    Data data = new Data();
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetProductEnquiry(drpPageSize.SelectedValue, pageIndex.ToString(), txtName.Text, txtEmail.Text,txtProduct.Text,txtFDate.Text,txtTdate.Text);
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            if (Request.QueryString["PageNo"] != null)
                ...
                pageNo = 1;
            Response.Redirect("Enquire.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
    }
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("Enquire.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
