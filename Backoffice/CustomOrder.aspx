<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CustomOrder.aspx.cs" Inherits="Backoffice_CustomOrder" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        ...
                                        <li><a href="CustomOrder.aspx">Custom Order</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Custom Order</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Custom Order</span> List</h1>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='View_CustomOrder.aspx?id=<%#Eval("ID") %>' class=" btn btn-info " rel="lightbox" style="color: white; width: 25px; padding: 4px 3px;"><i class="fa fa-eye fa-align-center" style="color: white;"></i></a>
