<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="addfeature_value.aspx.cs" Inherits="Backoffice_addfeature_value" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        ...
                                        <li><a href="Features.aspx">Product Features</a><span class="bread-slash">/</span>
                                        </li>
                                        <li><a runat="server" id="hrfval" >Product Features Value</a>
                                        </li>
                                    </ul>
                                    
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Add New Product Features Value</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                        ...
                        <div class="sparkline13-list shadow-reset">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1><i class="fa fa-tag btn btn-button-success-ct"></i><span class="table-project-n">PRODUCT FEATURE VALUE</span> </h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="login-input-head alignright" style="margin-right: 10px">
                                            <p><span style="color: red">*</span> Feature</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
