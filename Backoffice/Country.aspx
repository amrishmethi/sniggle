<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Country.aspx.cs" Inherits="Backoffice_Country" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        <li>Shipping <span class="bread-slash">/</span>
                                        </li>
                                        <li><a href="Country.aspx">Country</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Country</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignright" style="margin-top: -21px;">
                                        <li><a href="AddCountry.aspx">
                                            <h1 style="text-align: center"><i class="fa fa-plus-square" aria-hidden="true"></i></h1>
                                            <br />
                                            <h5 style="float: left">Add New Country</h5>
                                        </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Country</span> List</h1>
                            ...
                            <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="ISO code ">ISO code</th>
                                        <th data-field="Call prefix">Call prefix</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCountry" CssClass="form-control" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtISO" CssClass="form-control" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtCall" CssClass="form-control" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtZone" CssClass="form-control" runat="server"></asp:TextBox></td>
                                        <td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblid" runat="server" Text='<%#Eval("id_country") %>' Visible="false"></asp:Label>
                                                </td>
                                                <td><%#Eval("id_country") %></td>
                                                <td>
                                                    <%#Eval("name") %> 
                                                </td>
                                                <td>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='AddCountry.aspx?id=<%#Eval("id_country") %>' class="btn btn-custon-rounded-three btn-primary" style="width: 25px; padding: 4px 3px;"><i class="fa fa-pencil-square-o fa-align-center" style="color: white;"></i></a>
                                                        ...
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete ?');" CssClass="btn btn-small btn-danger"
                                                            CommandArgument='<%#Eval("id_country") %>' Style="width: 25px; padding: 4px 3px;"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    </div>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
