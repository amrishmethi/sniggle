...
public partial class Backoffice_CustomOrder : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.Cookies["Backoffice"] != null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    data.executeCommand("update tbl_CustomOrder set Notification=0 where EntryType='Custom' ");
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            Response.Redirect("CustomOrder.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
    }
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetCustomdmin(drpPageSize.SelectedValue, pageIndex.ToString(), txtName.Text, txtEmail.Text,txtFDate.Text,txtTdate.Text);
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("CustomOrder.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
