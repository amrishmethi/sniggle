...
public partial class Backoffice_Request_Quote : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.Cookies["Backoffice"] != null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    data.executeCommand("update tbl_CustomOrder set Notification=0 where EntryType='RAQ' ");
                    Response.Redirect("Request_Quote.aspx");
                }
    ...
    public void FillData(int pageIndex)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        ds = gdate.GetRAQdmin(drpPageSize.SelectedValue, pageIndex.ToString(), txtName.Text, txtEmail.Text,txtFDate.Text,txtTdate.Text);
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Data data = new Data();
            string query = "update tbl_CustomOrder set IsDeleted = 1 where ID=" + e.CommandArgument + "";
            ...
            Response.Redirect("Request_Quote.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue);
        }
    }
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("Request_Quote.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            {
                Data data = new Data();
                data.executeCommand("update tbl_CustomOrder set IsDeleted=1 where ID=" + lblid.Text);
            }
        }
