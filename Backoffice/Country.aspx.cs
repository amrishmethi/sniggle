...
public partial class Backoffice_Country : System.Web.UI.Page
{
    Data data = new Data();
    ...
    protected void rep_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Data data = new Data();
            string query = "update ps_country set IsDeleted = 1 where id_country=" + e.CommandArgument + "";
            data.executeCommand(query);
            string query1 = "update ps_country_lang set IsDeleted = 1 where id_country=" + e.CommandArgument + "";
            ...
            Response.Redirect("Country.aspx?PageNo=" + pageNo.ToString() + "&&PageSize=" + drpPageSize.SelectedValue); ;
        }
    }
    public void FillData(int pageIndex)
    {
        int dd = Convert.ToInt32(pageIndex);
        ds = gdate.GetCountry(PageSize.ToString(), pageIndex.ToString(),txtId.Text, txtCountry.Text, txtISO.Text.ToUpper(), txtCall.Text,txtZone.Text);
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PageSize"] != null)
            ...
            PageSize = 50;
        Response.Redirect("Country.aspx?PageNo=" + pageIndex.ToString() + "&&PageSize=" + PageSize.ToString());
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rep.Items.Count; i++)
        {
            ...
            {
                Data data = new Data();
                string query = "update ps_country set IsDeleted = 1 where id_country=" + lblid.Text + "";
                data.executeCommand(query);
                string query1 = "update ps_country_lang set IsDeleted = 1 where id_country=" + lblid.Text + "";
                data.executeCommand(query1);
            }
        }
