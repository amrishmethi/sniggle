<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CreativeCutsEnquiry.aspx.cs" Inherits="Backoffice_CreativeCutsEnquiry" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        <li><a href="CreativeCutsEnquiry.aspx">Creative Cuts</a> <span class="bread-slash">/</span>
                                        </li>
                                        <li><span>Enquire about this creative cuts product</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Enquire about this creative cuts product</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Enquire</span> List</h1>
                                ...
                                <tbody>
                                     <tr>
                                        ...
                                        <td>
                                          ...
                                          <td>
                                            <asp:TextBox ID="txtProduct" runat="server" CssClass="form-control"></asp:TextBox></td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="row">
                                                        <a href='ViewCreativeCutsEnquiry.aspx?id=<%#Eval("ID") %>' class=" btn btn-info " rel="lightbox" style="color: white; width: 25px; padding: 4px 3px;"><i class="fa fa-eye fa-align-center" style="color: white;"></i></a>
