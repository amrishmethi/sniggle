<%@ Page Title="" Language="C#" MasterPageFile="~/Backoffice/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CustomerPaymentStatus.aspx.cs" Inherits="Backoffice_CustomerPaymentStatus" %>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                                    <ul class="breadcome-menu alignleft" style="margin-top: -21px;">
                                        ...
                                        <li><a href="CustomerPaymentStatus.aspx">Customer Payment Status</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <h1 style="float: left">Customer Payment Status</h1>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="row">
                ...
                <div class="sparkline13-list shadow-reset" style="margin-left: 16px; margin-right: 16px;">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Customer Payment Status</span> List</h1>
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        <th data-field="Cart Id">Cart Id</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtCartId" runat="server" CssClass=" form-control"></asp:TextBox></td>
                                    ...
                                    <asp:Repeater ID="rep" runat="server">
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td><%# Total(Eval("AddId"),Eval("id_customer"),Eval("Total")) %></td>
                                                <td>
                                                    <%#Eval("Status") %>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="ViewCart.aspx?id=<%#Eval("id_cart") %>" class="btn btn-default" target="_blank">View</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
